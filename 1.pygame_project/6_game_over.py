...
while running:
    ...
    character_rect.left = int(character_xpos)
    character_rect.top = int(character_ypos)
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        ball_rect.left = int(ball_xpos)
        ball_rect.top = int(ball_ypos)
    ...
    for idx, val in enumerate(balls):
        ...
        screen.blit(ball_images[ball_img_idx], (int(ball_xpos), int(ball_ypos)))
    screen.blit(character, (int(character_xpos), int(character_ypos)))
